...
mod tests {
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("H5n6ikbF2i9RSGsNtrNFJV5KJgFaGkDsooCjmLYy3vs9").unwrap();
    ...
    fn final_task() {
        let rpc_client = RpcClient::new(RPC_URL);
        // Most common - reading from a JSON file
        // Read the file
        // Use ? to propagate the error
        let signer = read_keypair_file("original-wallet.json").expect("couldn't find a wallet");
